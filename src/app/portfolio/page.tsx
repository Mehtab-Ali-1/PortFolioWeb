...
export default function Portfolio () {
    return (
        <main className="max-w-screen-2xl justify-self-center w-screen ">
            ...
            <div className="md:h-72 w-full max-md:w-screen  bg-orange-100">
                ...
                <div className="md:text-4xl pt-20 font-bold  font-serif flex justify-center items-center">
                    <ul className="flex space-x-3 max-md:pb-10 md:pt-16 text-lg items-center select-none">
            ...
            {/* &&&&&&&&&&&&&&&&&&&&&&&&&&&& */}
            {/* heading */}
            <div className="text-3xl md:text-4xl font-serif text-blue-950 flex text-center justify-center pt-10 px-5 select-none">
                <h1>Showcasing My Journey in Web Development</h1>
            </div>

            <div className="md:flex justify-evenly items-center mt-12">
            {/* pic1  */}
                <div className=" flex flex-col items-center justify-center space-y-4 max-md:mb-8 select-none">
            ...
            {/* ***************** */}
        <div className="md:flex justify-center items-center space-x-5 px-7 select-none">
            {/* second web project */}
            <div>
                <div className=" flex flex-col items-center justify-center space-y-4 max-md:mb-8  md:pt-16 px-5 select-none">
        ...
        {/* calculator */}
        <div className="md:flex justify-center items-center select-none" >
